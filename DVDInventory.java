...
public class DVDInventory extends AppCompatActivity {
   ...
   /* Button Back;
    ...
    private Spinner DVDSpinner;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dvdinventory);
        ...
        submit.setOnClickListener(v -> {
            saveData();
            clearPreferences();
            String selectedItem = DVDSpinner.getSelectedItem().toString();
    ...
    private void initViews() {
        ...
        DVDSpinner = findViewById(R.id.DVDSpinner);
    ...
    private void createCSVFile() {
        ...
        try (FileWriter writer = new FileWriter(csvFile, true)){
            writer.append(String.format("%s, %s, %s, %s, %s, %s, %s\n",
                    ...
                    DVDSpinner.getSelectedItem().toString()));
            writer.flush();
    ...
    private void setUpViews() {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savePreferences();
                finish();
                Intent intent = new Intent(DVDInventory.this, MenuActivity.class);
    ...
    private void loadedSavedPreferences() {
        ...
        DVDSpinner.setSelection(spinnerPosition);
    }

    private void setUpSpinner() {

        List<String> dvd = new ArrayList<String>();
        dvd.add("Blu-Ray Disk");
        dvd.add("OD-05");
        dvd.add("OD-07");


        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, dvd);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);

        DVDSpinner = findViewById(R.id.DVDSpinner);
        Spinner DVDSpinner = findViewById(R.id.DVDSpinner);
        DVDSpinner.setAdapter(adapter);
        DVDSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String selectedItem = dvd.get(position);
            }
