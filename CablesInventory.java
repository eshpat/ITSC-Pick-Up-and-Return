...
public class CablesInventory extends AppCompatActivity {
    ...
    private Spinner CablesSpinner;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cables_inventory);
        ...
        submit.setOnClickListener(v -> {
            saveData();
            clearPreferences();
            String selectedItem = CablesSpinner.getSelectedItem().toString();
    ...
    private void initViews() {
        ...
        CablesSpinner = findViewById(R.id.CablesSpinner);
    ...
    private void createCSVFile() {
        ...
        try (FileWriter writer = new FileWriter(csvFile, true)){
            writer.append(String.format("%s, %s, %s, %s, %s, %s, %s\n",
                    ...
                    CablesSpinner.getSelectedItem().toString()));
            writer.flush();
    ...
    private void setUpViews() {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savePreferences();
                finish();
                Intent intent = new Intent(CablesInventory.this, MenuActivity.class);
    ...
    private void loadedSavedPreferences() {
        ...
        CablesSpinner.setSelection(spinnerPosition);
    }

    private void setUpSpinner() {

        List<String> cables = new ArrayList<String>();
        cables.add("3 foot ethernet");
        cables.add("6 foot ethernet");
        cables.add("15 foot ethernet");
        cables.add("20+ foot ethernet");
        cables.add("3+ HDMI");
        cables.add("6 foot HDMI");
        cables.add("10-15 foot HDMI");

        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, cables);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);

        Spinner spinnerCables = findViewById(R.id.CablesSpinner);
        spinnerCables.setAdapter(adapter);

        spinnerCables.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String selectedItem = cables.get(position);
            }
