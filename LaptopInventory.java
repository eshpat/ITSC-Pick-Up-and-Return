...
public class LaptopInventory extends AppCompatActivity {
    ...
    private Spinner LaptopSpinner;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_laptop_inventory);
        ...
        submit.setOnClickListener(v -> {
            saveData();
            clearPreferences();
            String selectedItem = LaptopSpinner.getSelectedItem().toString();
    ...
    private void initViews() {
        ...
        LaptopSpinner = findViewById(R.id.LaptopSpinner);
    ...
    private void createCSVFile() {
        ...
        try (FileWriter writer = new FileWriter(csvFile, true)) {
            writer.append(String.format("%s, %s, %s, %s, %s, %s, %s\n",
                    ...
                    LaptopSpinner.getSelectedItem().toString()));
            writer.flush();
    ...
    private void setUpViews() {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savePreferences();
                finish();
                Intent intent = new Intent(LaptopInventory.this, MenuActivity.class);
    ...
    private void loadedSavedPreferences() {
        ...
        LaptopSpinner.setSelection(spinnerPosition);
    }
    ...
    private void setUpSpinner() {
        ...
        Spinner spinnerLaptops = findViewById(R.id.LaptopSpinner);
        spinnerLaptops.setAdapter(adapter);

        spinnerLaptops.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String selectedItem = laptops.get(position);
            }
