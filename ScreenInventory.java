...
public class ScreenInventory extends AppCompatActivity {
   ...
   /* Button Back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_inventory);
        ...
        submit.setOnClickListener(v -> {
            saveData();
            clearPreferences();
            String selectedItem = ScreenSpinner.getSelectedItem().toString();
    ...
    private void createCSVFile() {
        ...
        try (FileWriter writer = new FileWriter(csvFile, true)){
            writer.append(String.format("%s, %s, %s, %s, %s, %s, %s\n",
                    ...
                    ScreenSpinner.getSelectedItem().toString()));
            writer.flush();
    ...
    private void setUpViews() {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savePreferences();
                finish();
                Intent intent = new Intent(ScreenInventory.this, MenuActivity.class);
    ...
    private void loadedSavedPreferences() {
        ...
        ScreenSpinner.setSelection(spinnerPosition);
    }

    private void setUpSpinner() {

        List<String> screen = new ArrayList<String>();
        screen.add("Screen-01");
        screen.add("Screen-02");
        screen.add("Screen-06");
        screen.add("Screen-08");
        screen.add("Screen-30''");


        ArrayAdapter<String> adapter = new ArrayAdapter<>(ScreenInventory.this, android.R.layout.simple_list_item_1, screen);
        ...
        ScreenSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String selectedItem = screen.get(position);
            }
