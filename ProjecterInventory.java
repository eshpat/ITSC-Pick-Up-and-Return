...
public class ProjecterInventory extends AppCompatActivity {
   ...
   /* Button Back;
    ...
    private Spinner ProjecterSpinner;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_projecter_inventory);
        ...
        submit.setOnClickListener(v -> {
            saveData();
            clearPreferences();
            String selectedItem = ProjecterSpinner.getSelectedItem().toString();
    ...
    private void initViews() {
        ...
        ProjecterSpinner = findViewById(R.id.ProjecterSpinner);
    ...
    private void createCSVFile() {
        ...
        try (FileWriter writer = new FileWriter(csvFile, true)){
            writer.append(String.format("%s, %s, %s, %s, %s, %s, %s\n",
                    ...
                    ProjecterSpinner.getSelectedItem().toString()));
            writer.flush();
    ...
    private void clearForm() {
        ...
        ProjecterSpinner.setSelection(0);
        clearPreferences();
    }
    ...
    private void setUpViews() {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savePreferences();
                finish();
                Intent intent = new Intent(ProjecterInventory.this, MenuActivity.class);
    ...
    private void loadedSavedPreferences() {
        ...
        ProjecterSpinner.setSelection(spinnerPosition);
    }

    private void setUpSpinner() {

        List<String> projecter = new ArrayList<String>();
        projecter.add("Projecter-01");
        projecter.add("Projecter-02");
        projecter.add("Projecter-03");
        projecter.add("Projecter-04");
        projecter.add("Projecter-05");



        ArrayAdapter<String> adapter = new ArrayAdapter<>(ProjecterInventory.this, android.R.layout.simple_list_item_1, projecter);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);

        Spinner ProjecterSpinner = findViewById(R.id.ProjecterSpinner);
        ProjecterSpinner.setAdapter(adapter);

        ProjecterSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String selectedItem = projecter.get(position);
            }
