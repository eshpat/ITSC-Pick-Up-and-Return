...
public class FlipChartInventory extends AppCompatActivity {
   ...
   /* Button Back;
    ...
    private Spinner FlipChartSpinner;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_flip_chart_inventory);
        ...
        submit.setOnClickListener(v -> {
            saveData();
            clearPreferences();
            String selectedItem = FlipChartSpinner.getSelectedItem().toString();
    ...
    private void initViews() {
        ...
        FlipChartSpinner = findViewById(R.id.FlipChartSpinner);
    ...
    private void createCSVFile() {
        ...
        try (FileWriter writer = new FileWriter(csvFile, true)){
            writer.append(String.format("%s, %s, %s, %s, %s, %s, %s\n",
                    ...
                    FlipChartSpinner.getSelectedItem().toString()));
            writer.flush();
    ...
    private void clearForm() {
        ...
        FlipChartSpinner.setSelection(0);
        clearPreferences();
    }
    ...
    private void setUpViews() {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savePreferences();
                finish();
                Intent intent = new Intent(FlipChartInventory.this, MenuActivity.class);
    ...
    private void loadedSavedPreferences() {
        ...
        FlipChartSpinner.setSelection(spinnerPosition);
    }

    private void setUpSpinner() {
        List<String> chart = new ArrayList<String>();
        chart.add("Flipchart-01");
        chart.add("Flipchart-02");
        chart.add("Flipchart-03");
        chart.add("Flipchart-05");
        chart.add("Flipchart-06");
        chart.add("Flipchart-07");
        chart.add("Flipchart-12");
        chart.add("Flipchart-13");
        chart.add("Flipchart-15");


        ArrayAdapter<String> adapter = new ArrayAdapter<>(FlipChartInventory.this, android.R.layout.simple_list_item_1, chart);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);

        Spinner FlipChartSpinner = findViewById(R.id.FlipChartSpinner);
        FlipChartSpinner.setAdapter(adapter);

        FlipChartSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String selectedItem = chart.get(position);
            }
