...
public class DocumentCameraInventory extends AppCompatActivity {
   ...
   /* Button Back;
    ...
    private Spinner DocumentCameraSpinner;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_document_camera_inventory);
        ...
        submit.setOnClickListener(v -> {
            saveData();
            clearPreferences();
            String selectedItem = DocumentCameraSpinner.getSelectedItem().toString();
    ...
    private void initViews() {
        ...
        DocumentCameraSpinner = findViewById(R.id.DocumentCameraSpinner);
    ...
    private void createCSVFile() {
        ...
        try (FileWriter writer = new FileWriter(csvFile, true)){
            writer.append(String.format("%s, %s, %s, %s, %s, %s, %s\n",
                    ...
                    DocumentCameraSpinner.getSelectedItem().toString()));
            writer.flush();
    ...
    private void clearForm() {
        ...
        DocumentCameraSpinner.setSelection(0);
        clearPreferences();
    }
    ...
    private void setUpViews() {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savePreferences();
                finish();
                Intent intent = new Intent(DocumentCameraInventory.this, MenuActivity.class);
    ...
    private void loadedSavedPreferences() {
        ...
        DocumentCameraSpinner.setSelection(spinnerPosition);
    }
    ...
    private void setUpSpinner() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(DocumentCameraInventory.this, android.R.layout.simple_list_item_1, camera);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);

        Spinner DocumentCameraSpinner = findViewById(R.id.DocumentCameraSpinner);
        DocumentCameraSpinner.setAdapter(adapter);

        DocumentCameraSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String selectedItem = camera.get(position);
            }
