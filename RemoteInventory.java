...
public class RemoteInventory extends AppCompatActivity {
   ...
   /* Button Back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remote_inventory);
        ...
        submit.setOnClickListener(v -> {
            saveData();
            clearPreferences();
            String selectedItem = RemoteSpinner.getSelectedItem().toString();
    ...
    private void initViews() {
        ...
        RemoteSpinner = findViewById(R.id.Remotespinner);
    ...
    private void createCSVFile() {
        ...
        try (FileWriter writer = new FileWriter(csvFile, true)){
            writer.append(String.format("%s, %s, %s, %s, %s, %s, %s\n",
                    ...
                    RemoteSpinner.getSelectedItem().toString()));
            writer.flush();
    ...
    private void setUpViews() {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savePreferences();
                finish();
                Intent intent = new Intent(RemoteInventory.this, MenuActivity.class);
    ...
    private void loadedSavedPreferences() {
        ...
        RemoteSpinner.setSelection(spinnerPosition);
    }

    private void setUpSpinner() {

        List<String> remotes = new ArrayList<String>();
        remotes.add("Green PR-03");
        remotes.add("Green PR-04");
        remotes.add("Green PR-07");
        remotes.add("Red PR-09");
        remotes.add("Red PR-10");

        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, remotes);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);

        Spinner remoteSpinner = findViewById(R.id.Remotespinner);
        ...
        remoteSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String selectedItem = remotes.get(position);
            }
            @Override
